...
reapp: #only rebuild web and backend
	@echo "${GREEN}Rebuilding web & backend containers...${RESET}"
	@make setup
	@${DOCKER} up -d --build --force-recreate web backend server
